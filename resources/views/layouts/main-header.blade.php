						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<!-- دا علشان اسجل خروج راوت ال لوج ان باي ديفولت بالاوزنتكاشن والسطر التاني هشرحه تحت 
								و انا لازم اعمل فورمه علشان الراوت مش بيدعم جييت ف هعمل فورم ب بوست
						            event.preventDefault() and document.getElementById() to log the user out of the website. 
							event.preventDefault() prevents the browser from loading the page that is being linked to,
							 instead document.getElementById() identifies the logout-form form and submits it.
						                           -->
